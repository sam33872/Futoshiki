...
public class Command {
     ...
     *  @param value*/
        ...
        public String toString() {
            return "Command " + command + ", row=" + row + ", column="+ column + ", value=" + value;
        }
        
        /***  Principally to be used in a switch statement to decide on the action to*  be taken, given this command
